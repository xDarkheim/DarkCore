...
class CacheRepositoryTest extends TestCase
{
    ...
    public function testLoadTimestampPrefixedJson(): void
    {
        file_put_contents($this->dir . 'prefixed.cache', "1700000000\n" . json_encode([['key' => 'val']], JSON_THROW_ON_ERROR));
        $result = $this->repo->load('prefixed.cache');
        $this->assertSame([['key' => 'val']], $result);
    }
