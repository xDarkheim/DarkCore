    ...
    <div class="col-md-6">
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                <?php else: ?>
                    <?php \Darkheim\Application\Shared\UI\MessageRenderer::inline('info', 'No data found in ' . _TBL_MS_ . ' for this account.'); ?>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php else: ?>
                    <?php \Darkheim\Application\Shared\UI\MessageRenderer::inline('info', 'No characters found.'); ?>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="col-md-6">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php else: ?>
                    <?php \Darkheim\Application\Shared\UI\MessageRenderer::inline('info', 'No IP address found.'); ?>
                <?php endif; ?>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php else: ?>
                    <?php \Darkheim\Application\Shared\UI\MessageRenderer::inline('info', 'No IP addresses found in the database.'); ?>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php else: ?>
                    <?php \Darkheim\Application\Shared\UI\MessageRenderer::inline('info', 'No connection history found for account.'); ?>
                <?php endif; ?>
            </div>
        </div>
        <?php endif; ?>
