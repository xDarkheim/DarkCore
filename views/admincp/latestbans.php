...
<div class="acp-tabs-wrap">
    ...
    <div class="acp-tab-content active" id="tab-temp">
        ...
        <?php else: ?>
        <div class="p-3"><?php \Darkheim\Application\Shared\UI\MessageRenderer::inline('info', 'No temporal bans logged.'); ?></div>
        <?php endif; ?>
    </div>
    ...
    <div class="acp-tab-content" id="tab-perm" style="display:none">
        ...
        <?php else: ?>
        <div class="p-3"><?php \Darkheim\Application\Shared\UI\MessageRenderer::inline('info', 'No permanent bans logged.'); ?></div>
        <?php endif; ?>
    </div>
</div>
