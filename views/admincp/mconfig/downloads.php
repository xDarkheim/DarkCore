...
$downloadsConfigUrl     = (string) ($downloadsConfigUrl ?? '');
$downloadsConfigUrlEsc  = downloadEsc($downloadsConfigUrl);
$downloadsDeleteUrlBase = (string) ($downloadsDeleteUrlBase ?? '');
...
<table class="table table-striped table-bordered table-hover">
    ...
    foreach ($downloads as $thisDownload) {
        ...
        $deleteLink          = downloadEsc($downloadsDeleteUrlBase . $downloadId);
        echo '
	<form action="' . $downloadsConfigUrlEsc . '" method="post">
...
<hr>
<h3>Add Download</h3>
<form action="<?php echo $downloadsConfigUrlEsc; ?>" method="post">
<table class="table table-striped table-bordered table-hover">
	<tr>
		<th>Title</th>
		<th>Description</th>
