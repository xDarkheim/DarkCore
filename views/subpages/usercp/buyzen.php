        ...
        <form action="" method="post">
            <div class="ucp-buyzen-grid">
                <div class="ucp-form-group">
                    <label for="buyzen_character"><?php echo \Darkheim\Application\Shared\Language\Translator::phrase('buyzen_txt_3', true); ?></label>
                ...
                <div class="ucp-form-group">
                    <label for="buyzen_credits"><?php echo \Darkheim\Application\Shared\Language\Translator::phrase('buyzen_txt_4', true); ?></label>
