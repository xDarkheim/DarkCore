...
<div class="page-title"><span><?php echo \Darkheim\Application\Shared\Language\Translator::phrase('news_txt_4', true); ?></span></div>

<?php foreach ($viewItems as $entry): ?>
<article class="news-single">
    <header class="news-single-header">
        <div class="news-single-badge"><?php echo \Darkheim\Application\Shared\Language\Translator::phrase('news_txt_6', true); ?></div>
    ...
    <footer class="news-single-footer">
        ...
        <a href="<?php echo __BASE_URL__; ?>news/" class="news-back-link">
            ...
            <?php echo \Darkheim\Application\Shared\Language\Translator::phrase('news_txt_4', true); ?>
        </a>
    </footer>
</article>
<?php endforeach; ?>
...
<div class="news-page-header">
    <div class="news-page-header-left">
        <div class="news-page-header-title"><?php echo \Darkheim\Application\Shared\Language\Translator::phrase('news_txt_4', true); ?></div>
        ...
        <div class="news-card-content">
            ...
            <footer class="news-card-footer">
                <a href="<?php echo $entry['newsUrl']; ?>" class="news-readmore">
                    <?php echo \Darkheim\Application\Shared\Language\Translator::phrase('news_txt_3'); ?> →
                </a>
            </footer>
            <?php else: ?>
