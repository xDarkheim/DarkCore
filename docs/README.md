...
| ⚙️ [Configuration](configuration.md) | `cms.json` keys, `docker/config.env` variables, security notes |
...
| ⚙️ Edit CMS config | [Configuration → cms.json](configuration.md#cmsjson--main-config) |
...
| ✏️ Write a new test | [PHPUnit → Writing tests](phpunit.md#writing-tests) |
