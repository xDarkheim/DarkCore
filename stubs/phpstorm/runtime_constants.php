<?php
/**
 * IDE-only constant stubs for PhpStorm static analysis.
 *
...
if (false) {
    ...
    define('__PATH_ADMINCP_INC__', '');
    define('__PATH_ADMINCP_MODULES__', '');
    define('__PATH_NEWS_CACHE__', '');
    define('__PATH_NEWS_TRANSLATIONS_CACHE__', '');
    ...
    define('__PATH_PLAYER_PROFILES_CACHE__', '');
    define('__PATH_MODULES_RANKINGS__', '');
    define('__PATH_ADMINCP_HOME__', '');
    define('__PATH_IMG__', '');
    define('__PATH_COUNTRY_FLAGS__', '');
    define('__PATH_API__', '');
    define('__PATH_ONLINE_STATUS__', '');
    define('__PATH_OFFLINE_STATUS__', '');
    define('__PATH_ASSETS__', '');
    define('__PATH_ASSETS_CSS__', '');
    define('__PATH_ASSETS_JS__', '');

    define('DARKHEIM_DATABASE_ERRORLOG', '');
