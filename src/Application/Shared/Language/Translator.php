 ...
 *
 * Replaces the inline logic inside the global \Darkheim\Application\Shared\Language\Translator::phrase() / \Darkheim\Application\Shared\Language\Translator::phraseFmt() helpers.
...
final class Translator
{
     ...
     */
    public static function phrase(string $key, bool $legacy = false): string
    {
